sap.ui.define([
	...
	return Controller.extend("tool_master.controller.FBL3NLC", {
		onInit: function () {
...
//		+"&apbudatbis="+apbudatbis+"&alpbudatvon="+alpbudatvon+"&alpbudatbis="+alpbudatbis;
		var source = "/pentaho?portalInterceptorAppId=tool_master&mandt="+mandt+"&bukrs="+bukrs+"&account_von="+account_von+"&p_ktopl="+p_ktopl+"&debistatus="+debistatus+"&stichtag="+stichtag+"&apstichtag="+apstichtag+"&apbudatvon="+apbudatvon
