sap.ui.define([
	...
	return Controller.extend("tool_master.controller.FK10N", {
		onInit: function () {
		...
		handleValueHelpCustomer: function () {
			if (!this._oValueHelpDialogCustomer) {
				Fragment.load({
					name: "tool_master.view.ValueHelpCustomer",
					controller: this
		...
		showVendor: function () {
			...
			this._oValueHelpDialogVendor = sap.ui.xmlfragment("tool_master.view.fragment.VendorFragment", this);
