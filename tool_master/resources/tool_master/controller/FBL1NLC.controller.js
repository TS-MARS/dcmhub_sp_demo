sap.ui.define([
	...
	return Controller.extend("tool_master.controller.FBL1NLC", {
		onInit: function () {
...
//		+"&apbudatbis="+apbudatbis+"&alpbudatvon="+alpbudatvon+"&alpbudatbis="+alpbudatbis;
		var source = "/pentaho?portalInterceptorAppId=tool_master&mandt="+mandt+"&bukrs="+bukrs+"&lifnr_von="+lifnr_von+"&p_hkont="+p_hkont+"&debistatus="+debistatus+"&stichtag="+stichtag+"&apstichtag="+apstichtag+"&apbudatvon="+apbudatvon
