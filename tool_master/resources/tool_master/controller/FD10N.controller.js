sap.ui.define([
	...
	return Controller.extend("tool_master.controller.FD10N", {
		onInit: function () {
		...
		showCustomer: function () {
			...
			this._oValueHelpDialogCustomer = sap.ui.xmlfragment("tool_master.view.fragment.CustomerFragment", this);
			this.getView().addDependent(this._oValueHelpDialogCustomer);
