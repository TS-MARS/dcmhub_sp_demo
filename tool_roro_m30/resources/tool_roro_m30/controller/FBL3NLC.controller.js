sap.ui.define([
	...
	return Controller.extend("tool_roro_m30.controller.FBL3NLC", {
		onInit: function () {
...
//		+"&apbudatbis="+apbudatbis+"&alpbudatvon="+alpbudatvon+"&alpbudatbis="+alpbudatbis;
		var source = "/pentaho?portalInterceptorAppId=tool_roro_m30&mandt="+mandt+"&bukrs="+bukrs+"&account_von="+account_von+"&p_ktopl="+p_ktopl+"&debistatus="+debistatus+"&stichtag="+stichtag+"&apstichtag="+apstichtag+"&apbudatvon="+apbudatvon
