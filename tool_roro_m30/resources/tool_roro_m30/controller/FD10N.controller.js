sap.ui.define([
	...
	return Controller.extend("tool_roro_m30.controller.FD10N", {
		onInit: function () {
			...
			var variantModel;
			oPersonalizationService.getContainer("sap.ushell.variant.FD10N_roro_m30", oScope, oComponent)
				.fail(function () {
		...
		_modelCalculation: function (oClient, oCCode, oCustomer, oYear) {
			...
			return new Promise(function (resolve, reject) {
				...
				oF10Model.read(
					"/fd10nParameters(IP_MANDT='" + oClient + "',IP_KUNNR='" + oCustomer + "',IP_BUKRS='" + oCCode + "',IP_GJAHR='" + oYear +
					"')/Results", {
						success: function (oResult) {
		...
		_modelCalculationSL: function (oClient, oCCode, oCustomer, oYear) {
			...
			return new Promise(function (resolve, reject) {
				...
				oF10Model.read(
					"/fd10nslParameters(IP_MANDT='" + oClient + "',IP_KUNNR='" + oCustomer + "',IP_BUKRS='" + oCCode + "',IP_GJAHR='" + oYear +
					"')/Results", {
						success: function (oResult) {
							var oLocale = sap.ui.getCore().getConfiguration().getLanguage();
		...
		showCustomer: function () {
			...
			this._oValueHelpDialogCustomer = sap.ui.xmlfragment("tool_roro_m30.view.fragment.CustomerFragment", this);
			this.getView().addDependent(this._oValueHelpDialogCustomer);
