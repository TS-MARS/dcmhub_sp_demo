sap.ui.define([
	...
	return Controller.extend("tool_roro_m30.controller.FBL1NLC", {
		onInit: function () {
		...
		onPressNext: function (oEvent) {
		   ...
		   var lifnr_von = oView.byId("lifnr_von").getValue();
		   if (lifnr_von === "")
		   {
		   	lifnr_von = " ";
		   }
...
//		+"&apbudatbis="+apbudatbis+"&alpbudatvon="+alpbudatvon+"&alpbudatbis="+alpbudatbis;
		var source = "/pentaho?portalInterceptorAppId=tool_roro_m30&mandt="+mandt+"&bukrs="+bukrs+"&lifnr_von="+lifnr_von+"&p_hkont="+p_hkont+"&debistatus="+debistatus+"&stichtag="+stichtag+"&apstichtag="+apstichtag+"&apbudatvon="+apbudatvon
