sap.ui.define([
	...
	return Controller.extend("tool_roro_m30.controller.FS10N", {
		onInit: function () {
			...
			var variantModel;
			oPersonalizationService.getContainer("sap.ushell.variant.FS10N_roro_m30", oScope, oComponent)
				.fail(function () {
		...
		handleValueHelpAccount: function () {
			if (!this._oValueHelpDialogCustomer) {
				Fragment.load({
					name: "tool_roro_m30.view.ValueHelpAccount",
					controller: this
		...
		showAccount: function () {
			...
			this._oValueHelpDialogAccount = sap.ui.xmlfragment("tool_roro_m30.view.fragment.AccountFragmentSingle", this);
			this.getView().addDependent(this._oValueHelpDialogAccount);
