sap.ui.define([
	...
	return Controller.extend("tool_roro_m30.controller.FBL5NLC", {
		onInit: function () {
...
//		+"&apbudatbis="+apbudatbis+"&alpbudatvon="+alpbudatvon+"&alpbudatbis="+alpbudatbis;
		var source = "/pentaho?portalInterceptorAppId=tool_roro_m30&mandt="+mandt+"&bukrs="+bukrs+"&kunnr_von="+kunnr_von+"&p_hkont="+p_hkont+"&debistatus="+debistatus+"&stichtag="+stichtag+"&apstichtag="+apstichtag+"&apbudatvon="+apbudatvon
