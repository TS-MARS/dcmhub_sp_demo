sap.ui.define([
	...
	return Controller.extend("tool_sp_demo.controller.FK10N", {
		onInit: function () {
			...
			var variantModel;
			oPersonalizationService.getContainer("sap.ushell.variant.FK10N_sp_demo", oScope, oComponent)
				.fail(function () {
		...
		showVendor: function () {
			...
			this._oValueHelpDialogVendor = sap.ui.xmlfragment("tool_sp_demo.view.fragment.VendorFragment", this);
