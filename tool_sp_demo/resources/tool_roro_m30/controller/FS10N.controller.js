sap.ui.define([
	...
	return Controller.extend("tool_sp_demo.controller.FS10N", {
		onInit: function () {
			...
			var variantModel;
			oPersonalizationService.getContainer("sap.ushell.variant.FS10N_sp_demo", oScope, oComponent)
				.fail(function () {
		...
		handleValueHelpAccount: function () {
			if (!this._oValueHelpDialogCustomer) {
				Fragment.load({
					name: "tool_sp_demo.view.ValueHelpAccount",
					controller: this
		...
		showAccount: function () {
			...
			this._oValueHelpDialogAccount = sap.ui.xmlfragment("tool_sp_demo.view.fragment.AccountFragmentSingle", this);
			this.getView().addDependent(this._oValueHelpDialogAccount);
