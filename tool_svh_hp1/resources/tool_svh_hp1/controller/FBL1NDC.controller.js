sap.ui.define([
	...
	return Controller.extend("tool_svh_hp1.controller.FBL1NDC", {
		onInit: function () {
...
//		+"&apbudatbis="+apbudatbis+"&alpbudatvon="+alpbudatvon+"&alpbudatbis="+alpbudatbis;
		var source = "/pentaho?portalInterceptorAppId=tool_svh_hp1&mandt="+mandt+"&bukrs="+bukrs+"&lifnr_von="+lifnr_von+"&p_hkont="+p_hkont+"&debistatus="+debistatus+"&stichtag="+stichtag+"&apstichtag="+apstichtag+"&apbudatvon="+apbudatvon
