sap.ui.define([
	...
	return Controller.extend("tool_svh_hp1.controller.FK10N", {
		onInit: function () {
			...
			var variantModel;
			oPersonalizationService.getContainer("sap.ushell.variant.FK10N_master", oScope, oComponent)
				.fail(function () {
		...
		handleValueHelpCompany: function () {
			if (!this._oValueHelpDialog) {
				Fragment.load({
					name: "tool_svh_hp1.view.ValueHelpCompany",
					controller: this
		...
		handleValueHelpCustomer: function () {
			if (!this._oValueHelpDialogCustomer) {
				Fragment.load({
					name: "tool_svh_hp1.view.ValueHelpCustomer",
					controller: this
		...
		showCompanyCode: function () {
			...
			this._oValueHelpDialogCompanyCode = sap.ui.xmlfragment("tool_svh_hp1.view.fragment.CompanyCodeFragment", this);
		...
		showVendor: function () {
			...
			this._oValueHelpDialogVendor = sap.ui.xmlfragment("tool_svh_hp1.view.fragment.VendorFragment", this);
