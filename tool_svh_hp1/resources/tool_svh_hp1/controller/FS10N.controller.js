sap.ui.define([
	...
	return Controller.extend("tool_svh_hp1.controller.FS10N", {
		onInit: function () {
		...
		handleValueHelpAccount: function () {
			if (!this._oValueHelpDialogCustomer) {
				Fragment.load({
					name: "tool_svh_hp1.view.ValueHelpAccount",
					controller: this
		...
		showAccount: function () {
			...
			this._oValueHelpDialogAccount = sap.ui.xmlfragment("tool_svh_hp1.view.fragment.AccountFragmentSingle", this);
			this.getView().addDependent(this._oValueHelpDialogAccount);
