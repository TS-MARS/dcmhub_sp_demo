sap.ui.define([
	...
	return Controller.extend("tool_svh_hp1.controller.FD10N", {
		onInit: function () {
			...
			var variantModel;
			oPersonalizationService.getContainer("sap.ushell.variant.FD10N_master", oScope, oComponent)
				.fail(function () {
		...
		showCustomer: function () {
			...
			this._oValueHelpDialogCustomer = sap.ui.xmlfragment("tool_svh_hp1.view.fragment.CustomerFragment", this);
			this.getView().addDependent(this._oValueHelpDialogCustomer);
